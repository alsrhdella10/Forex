package com.alsarahdella201103660.forex;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initForex() {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=50af607aa1c945458c227046ecf3bd02";
        ...
        asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                ...
                double rub = ratesModel.getRUB();

                idrTextView.setText(formatNumber(idr,"###,##0.00"));
                btcTextView.setText(formatNumber(btc,"###,##0.00"));
                eurTextView.setText(formatNumber(eur,"###,##0.00"));
                usdTextView.setText(formatNumber(usd,"###,##0.00"));
                hkdTextView.setText(formatNumber(hkd,"###,##0.00"));
                bobTextView.setText(formatNumber(bob,"###,##0.00"));
                audTextView.setText(formatNumber(aud,"###,##0.00"));
                inrTextView.setText(formatNumber(inr,"###,##0.00"));
                phpTextView.setText(formatNumber(php,"###,##0.00"));
                rubTextView.setText(formatNumber(rub,"###,##0.00"));
